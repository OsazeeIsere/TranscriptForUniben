<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="TranscriptForUniben.dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div  runat="server" visible="false" id="divtranscriptStatus" class="auto-style1">
     ...
     <div runat="server" id="divcoment" margin="50%" visible="False">
      ...
      <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.6s">
        <h2>You are welcome As <asp:Label ID="lbluserrole" runat="server" Text=""></asp:Label></h2>
          ...
          <div class="items" runat="server" visible="false" id="divusers">
           ...
           <div class="items" runat="server" visible="false" id="divtranscript">
               ...
               <asp:Button ID="btngeneratetranscript" runat="server" Text="Generate" PostBackUrl="~/transcript.aspx" CssClass="btn_item" />
                         <br />
                    <asp:Button ID="btnviewtranscript" runat="server" Text="View" CssClass="btn_item" PostBackUrl="~/viewtranscript.aspx" OnClick="btnviewtranscript_Click" />
                         <br />
        ...
        <div class="items" runat="server" visible="false" id="divstudents">
                     <h3>Students</h3>
                      <asp:Button ID="btnaddstudent" runat="server" Text="Add New" PostBackUrl="~/students.aspx" CssClass="btn_item" />
                         <br />
                      <asp:Button ID="btnuploadsstudents" runat="server" Text="Bulk Upload" CssClass="btn_item" />
                         <br />
                      <asp:Button ID="btnmanageStudent" runat="server" Text="Manage Students Profile" CssClass="btn_item" />
                 </div>
