<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="UploadStudents.aspx.cs" Inherits="StudentsInformationSystem.UploadStudents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center">
      ...
      <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.6s">
        <h2> You Are About To Upload Students' Information To The Central Data Base For Transcript Generation</h2>
      </div>
    </div>
  </div>
